...
SOURCE_LABELS = {
    ...
    "mpo_graph_tns_veryhard_fast_cpu": "veryhard_fast_cpu",
    "mpo_graph_tns_veryhard_fast_cpu_b": "veryhard_fast_cpu_b",
    "mpo_graph_tns_veryhard_fast_cpu_c": "veryhard_fast_cpu_c",
    "mpo_graph_tns_veryhard_fast_cpu_d": "veryhard_fast_cpu_d",
    "mpo_graph_tns_veryhard_fast_cpu_e": "veryhard_fast_cpu_e",
    "mpo_veryhard_ultrafast_cpu": "ultrafast_cpu",
    "mpo_veryhard_ultrafast_cpu_s2": "ultrafast_cpu_s2",
    "mpo_graph_tns_veryhard_fast_cpu_f": "veryhard_fast_cpu_f",
    "mpo_graph_tns_veryhard_fast_cpu_g": "veryhard_fast_cpu_g",
    "mpo_graph_tns_marginal_fallback_cpu": "marginal_fallback_cpu",
...
def build_report(root: Path, output: Path, image_dir: Path, top_limit: int) -> dict[str, Any]:
    ...
    lines = [
        ...
        "",
        "This report summarizes the current `peaked_mpo_graph_tns` outputs in this worktree. "
        ...
        "- Active extra retry jobs include the carried-over graph/TNS arrays, `34619926` -> `veryhard_fast_cpu`, and any newer env-variant fast arrays for the remaining very-hard challenges.",
        "- Current replacement/dependency-gated jobs include the missing/combined rollups when present in Slurm.",
        "",
