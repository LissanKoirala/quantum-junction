...
Generated: 2026-06-06T16:21:07+01:00
...
- Workload CPU running now: 37 tasks, 1064 cores
...
- Source records: all_cpu:started, all_gpu:started, missing_cpu:started, extra_cpu:started, extra_cpu_f:started, marginal_fallback:no_candidate/unknown, vhard_fast:preempted, vhard_fast_b:error, vhard_fast_c:started, vhard_fast_d:error, vhard_fast_e:terminated, vhard_fast_f:ok/unknown
...
- Source records: all_cpu:started, all_gpu:preempted, gpu_retry:started, missing_cpu:started, extra_cpu:started, extra_cpu_f:started, marginal_fallback:no_candidate/unknown, vhard_fast:preempted, vhard_fast_b:error, vhard_fast_c:error, vhard_fast_d:error, vhard_fast_e:started, vhard_fast_f:ok/unknown
- Marginal P(0) raw-site prefix: `, , , , , , , , , , , , ...`
...
- Source records: all_cpu:started, all_gpu:started, extra_cpu:started, extra_cpu_b:started, extra_cpu_f:started, marginal_fallback:terminated, vhard_fast:preempted, vhard_fast_b:error, vhard_fast_c:error, vhard_fast_d:error, vhard_fast_e:started, vhard_fast_g:started
...
- Source records: all_cpu:started, all_gpu:started, missing_cpu:started, extra_cpu:started, extra_cpu_f:started, marginal_fallback:terminated, vhard_fast:started, vhard_fast_b:error, vhard_fast_c:started, vhard_fast_d:error, vhard_fast_e:started, vhard_fast_g:error
...
- Source records: all_cpu:started, all_gpu:started, extra_cpu:started, extra_cpu_b:started, extra_cpu_f:started, marginal_fallback:terminated, vhard_fast:error, vhard_fast_b:error, vhard_fast_c:started, vhard_fast_d:error, vhard_fast_e:started, vhard_fast_g:started
